...
#' }
#' }
OptimizerAsyncMbo_rush = R6Class(
  "OptimizerAsyncMbo",
  ...
  private = list(
    ...
    .optimize = function(inst) {
      ...
      mlr3misc::get_private(inst)$.eval_queue()
        ...
        xs = tryCatch(
          {
            ...
            xs = mlr3misc::transpose_list(xdt)[[1L]]
          ...
          Mlr3ErrorMbo = function(cond) {
            ...
            xdt = paradox::generate_design_random(inst$search_space, n = 1L)$data
            xs = mlr3misc::transpose_list(xdt)[[1L]]
            c(xs, list(
