...
class(bayesopt_mpcl_rush) = "loop_function"
attr(bayesopt_mpcl_rush, "id") = "bayesopt_mpcl_rush"
attr(bayesopt_mpcl_rush, "label") = "Multipoint Constant Liar"
attr(bayesopt_mpcl_rush, "instance") = "single-crit"
attr(bayesopt_mpcl_rush, "man") = "mlr3mbo::mlr_loop_functions_mpcl"
